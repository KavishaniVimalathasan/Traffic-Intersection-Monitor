...
VIDEO_SOURCE = "VIDEO/Traffic_Side.mp4"
    ...
    while True:
        ...
        if result.boxes.id is not None:
            ...
            for box, class_id, track_id in zip(boxes, class_ids, track_ids):
                ...
                # Turn zone tracking
                inside_turn_zone = point_in_zone(center, ZONE_TOP_LEFT, ZONE_BOTTOM_RIGHT)
                ...
                if inside_turn_zone and not state["was_inside"]:
                    ...
                    state["entry_side"] = get_side(center, ZONE_TOP_LEFT, ZONE_BOTTOM_RIGHT)
                    ...
                    exit_side = get_side(center, ZONE_TOP_LEFT, ZONE_BOTTOM_RIGHT)
